...
{
    public class NovemberController : Controller
    {
        private readonly IStringLocalizer<NovemberController> _localizer;

        public NovemberController(IStringLocalizer<NovemberController> localizer)
        {
