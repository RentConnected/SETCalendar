...
{
    public class SeptemberController : Controller
    {
        private readonly IStringLocalizer<SeptemberController> _localizer;

        public SeptemberController(IStringLocalizer<SeptemberController> localizer)
        {
