...
{
    public class JulyController : Controller
    {
        private readonly IStringLocalizer<JulyController> _localizer;

        public JulyController(IStringLocalizer<JulyController> localizer)
        {
