...
{
    public class AugustController : Controller
    {
        private readonly IStringLocalizer<AugustController> _localizer;

        public AugustController(IStringLocalizer<AugustController> localizer)
        {
