...
{
    public class OctoberController : Controller
    {
        private readonly IStringLocalizer<OctoberController> _localizer;

        public OctoberController(IStringLocalizer<OctoberController> localizer)
        {
